 ...
 * @subpackage Alphalabs_Utility_Pack/admin
 */
 ...
 */
class Alphalabs_Utility_Pack_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/alphalabs-utility-pack-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/alphalabs-utility-pack-admin.js', array( 'jquery' ), $this->version, false );
